/*
(Beta) Greedy Snake 0.0.7-Code [2023-12-06]
*/
#include<bits/stdc++.h>
#include<conio.h>
#include<time.h>
...
{
    system("cls");
    cout<<"(Beta) Greedy Snake 0.0.7 [2023-12-06]  < "<<characters<<" >"<<endl<<endl;
...
int main()
{
	...
	{
		system("cls");
		cout<<"(Beta) Greedy Snake 0.0.7 [2023-12-06]"<<endl<<endl;
		cout<<"Loading"<<endl;
		Sleep(1000);
		system("cls");
		cout<<"(Beta) Greedy Snake 0.0.7 [2023-12-06]"<<endl<<endl;
	...
	{
		system("cls");
		cout<<"(Beta) Greedy Snake 0.0.7 [2023-12-06]  < "<<fruitAll<<" Fruits >"<<endl<<endl;
