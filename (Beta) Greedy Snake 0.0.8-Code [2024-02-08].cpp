/*
(Beta) Greedy Snake 0.0.8-Code [2024-02-08]
*/
#include<bits/stdc++.h>
#include<conio.h>
#include<time.h>
...
{
    system("cls");
    cout<<"(Beta) Greedy Snake 0.0.8 [2024-02-08]  < "<<characters<<" >"<<endl<<endl;
...
int main()
{
	...
	{
		system("cls");
		cout<<"(Beta) Greedy Snake 0.0.8 [2024-02-08]"<<endl<<endl;
		cout<<"Loading"<<endl;
		Sleep(1000);
		system("cls");
		cout<<"(Beta) Greedy Snake 0.0.8 [2024-02-08]"<<endl<<endl;
	...
	{
		system("cls");
		cout<<"(Beta) Greedy Snake 0.0.8 [2024-02-08]  < "<<fruitAll<<" Fruits >"<<endl<<endl;
