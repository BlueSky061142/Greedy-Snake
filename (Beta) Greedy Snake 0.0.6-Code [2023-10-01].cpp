/*
(Beta) Greedy Snake 0.0.6-Code [2023-10-01]
*/
#include<bits/stdc++.h>
#include<conio.h>
#include<time.h>
...
{
    system("cls");
    cout<<"(Beta) Greedy Snake 0.0.6 [2023-10-01]  < "<<characters<<" >"<<endl<<endl;
...
int main()
{
	...
	{
		system("cls");
		cout<<"(Beta) Greedy Snake 0.0.6 [2023-10-01]"<<endl<<endl;
		cout<<"Loading"<<endl;
		Sleep(1000);
		system("cls");
		cout<<"(Beta) Greedy Snake 0.0.6 [2023-10-01]"<<endl<<endl;
	...
	{
		system("cls");
		cout<<"(Beta) Greedy Snake 0.0.6 [2023-10-01]  < "<<fruitAll<<" Fruits >"<<endl<<endl;
