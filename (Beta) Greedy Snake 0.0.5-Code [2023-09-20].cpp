/*
(Beta) Greedy Snake 0.0.5-Code [2023-09-20]
*/
#include<bits/stdc++.h>
#include<conio.h>
#include<time.h>
...
{
    system("cls");
    cout<<"(Beta) Greedy Snake 0.0.5 [2023-09-20]  < "<<characters<<" >"<<endl<<endl;
...
int main()
{
	...
	{
		system("cls");
		cout<<"(Beta) Greedy Snake 0.0.5 [2023-09-20]"<<endl<<endl;
		cout<<"Loading"<<endl;
		Sleep(1000);
		system("cls");
		cout<<"(Beta) Greedy Snake 0.0.5 [2023-09-20]"<<endl<<endl;
	...
	{
		system("cls");
		cout<<"(Beta) Greedy Snake 0.0.5 [2023-09-20]  < "<<fruitAll<<" Fruits >"<<endl<<endl;
