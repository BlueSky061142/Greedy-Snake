/*
(Gamma) Greedy Snake 0.1.0-Code [2024-02-10]
*/
#include<bits/stdc++.h>
#include<conio.h>
#include<time.h>
...
{
    system("cls");
    cout<<"(Gamma) Greedy Snake 0.1.0 [2024-02-10]  < "<<characters<<" >"<<endl<<endl;
...
int main()
{
	...
	{
		system("cls");
		cout<<"(Gamma) Greedy Snake 0.1.0 [2024-02-10]"<<endl<<endl;
		cout<<"Loading"<<endl;
		Sleep(1000);
		system("cls");
		cout<<"(Gamma) Greedy Snake 0.1.0 [2024-02-10]"<<endl<<endl;
	...
	{
		system("cls");
		cout<<"(Gamma) Greedy Snake 0.1.0 [2024-02-10]  < "<<fruitAll<<" Fruits >"<<endl<<endl;
