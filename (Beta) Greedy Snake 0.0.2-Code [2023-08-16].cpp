/*
(Beta) Greedy Snake 0.0.2-Code [2023-08-16]
*/
#include<bits/stdc++.h>
#include<conio.h>
#include<time.h>
...
{
    system("cls");
    cout<<"(Beta) Greedy Snake 0.0.2 [2023-08-16]"<<endl<<endl;
...
int main()
{
	MessageBox(NULL,"Press OK To Start The Game.","(Beta) Greedy Snake 0.0.2 [2023-08-16]",MB_OK);
    Setup();
    while(!gameOver)
	{
        Draw();
