/*
(Official) Greedy Snake 0.1.0-Code [2023-10-01]
*/
#include<bits/stdc++.h>
#include<conio.h>
#include<time.h>
...
{
    system("cls");
    cout<<"(Official) Greedy Snake 0.1.0 [2023-10-01]  < "<<characters<<" >"<<endl<<endl;
...
int main()
{
	...
	{
		system("cls");
		cout<<"(Official) Greedy Snake 0.1.0 [2023-10-01]"<<endl<<endl;
		cout<<"Loading"<<endl;
		Sleep(1000);
		system("cls");
		cout<<"(Official) Greedy Snake 0.1.0 [2023-10-01]"<<endl<<endl;
	...
	{
		system("cls");
		cout<<"(Official) Greedy Snake 0.1.0 [2023-10-01]  < "<<fruitAll<<" Fruits >"<<endl<<endl;
